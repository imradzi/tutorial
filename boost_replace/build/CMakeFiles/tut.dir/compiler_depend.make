...
tut: /lib/x86_64-linux-gnu/libc.so.6 \
  ...
  /usr/local/lib/libboost_atomic.so.1.86.0 \
  /usr/local/lib/libboost_container.so.1.86.0 \
  /usr/local/lib/libboost_filesystem.so.1.86.0 \
  /usr/local/lib/libboost_json.so.1.86.0 \
  /usr/local/lib/libboost_program_options.so.1.86.0 \
  /usr/local/lib/libboost_serialization.so.1.86.0 \
...
/home/radzi/cmake/tutorial/boost_replace/main.cpp:
